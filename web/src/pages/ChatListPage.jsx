  ...
  return (
    <>
      <div className="sidebar" style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        {/* Header */}
        <div style={{ padding: '16px', display: 'flex', alignItems: 'center', gap: 16, borderBottom: '1px solid var(--ora-border)', flexShrink: 0 }}>
            ...
            >
              ...
              <div style={{ flex: 1, overflow: 'hidden' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                  ...
                  <span style={{ fontSize: 12, color: 'var(--ora-text-muted)', flexShrink: 0 }}>{chat.timestamp}</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  {chat.unread > 0 && (
                    <span style={{ background: 'var(--ora-blue)', color: '#fff', fontSize: 12, fontWeight: 'bold', padding: '2px 8px', borderRadius: 12, flexShrink: 0, marginLeft: 8 }}>{chat.unread}</span>
                  )}
                </div>
              </div>
            </Link>
